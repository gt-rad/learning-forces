...
public:
	...
	*/
    ...
    /**
     \brief Sets the collision friction coefficient for self collision.
     \param [in] selffrictionCoefficient New friction coefficient between 0.0 and 1.0 (default: 0.0).
     */
    virtual void setSelfFrictionCoefficient(PxReal frictionCoefficient) = 0;
    /**
     \brief Returns the self friction coefficient.
     \return self Friction coefficient.
     */
    virtual PxReal getSelfFrictionCoefficient() const = 0;
    
    /**
     \brief Sets the power for the stiffness.
     \param [in] stiffnesspower between 0 and 10 (default: 0).
     */
    virtual void setStiffnessPower(uint32_t stiffpower) = 0;
    /**
     \brief Returns the power for the stiffness.
     \return the power for the stiffness.
     */
    virtual uint32_t getStiffnessPower() const = 0;
	...
	*/
    ...
    // START ADDED BY NSF-DRESSING
    virtual PxVec3 getAccumulatedCollisionForce() const = 0;
    
    virtual float* getContactForces() const = 0;
    virtual float* getFrictionForces() const = 0;
    virtual void setSolverFlags(char) const = 0;
    // END ADDED BY NSF-DRESSING
