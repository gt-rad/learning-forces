...
private:
	...
	void collideContinuousParticles(float);
    // START ADDED BY NSF-DRESSING
	...
	// START ADDED BY NSF-DRESSING
	// record positions before collision
    void recordPreCollisionPositions();
    // get collision forces from differentiating particle positions before & after collision
    void retrieveCollisionPositions();
