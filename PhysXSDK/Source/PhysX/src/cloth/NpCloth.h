...
//~PX_SERIALIZATION
    ...
    virtual		void				setSelfFrictionCoefficient(PxReal frictionCoefficient);
    virtual		PxReal				getSelfFrictionCoefficient() const;
    
    virtual		void				setStiffnessPower(uint32_t);
	...
	//---------------------------------------------------------------------------------
    // START ADDED BY NSF-DRESSING
    virtual     PxVec3              getAccumulatedCollisionForce() const;
    
    virtual     float*             getContactForces() const;
    virtual     float*             getFrictionForces() const;
    
    virtual     void               setSolverFlags(char) const;
    // START ADDED BY NSF-DRESSING
public:
