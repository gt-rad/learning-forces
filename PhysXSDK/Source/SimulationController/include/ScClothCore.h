...
//~PX_SERIALIZATION
        ...
        PxReal					getSelfFrictionCoefficient() const;
        void					setSelfFrictionCoefficient(PxReal frictionCoefficient);
        
        uint32_t					getStiffnessPower() const;
        void					setStiffnessPower(uint32_t stiffpower);
		...
		void					setClothFlag(PxClothFlag::Enum flag, bool val);
	...
	public:
		...
		PX_FORCE_INLINE bool	isGpu() const { return mClothFlags & PxClothFlag::eGPU; }
        ...
        void setSolverFlags(char) const;
        // END ADDED BY NSF-DRESSING
